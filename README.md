...
**Description**: Create a web page for CMF College. The website is to contain the following:

1. A brief introduction on RACHEL a digital education server
2. An introduction to Khan Academy and how to use to for their learning
3. An introduction on the various other resources loaded in RACHEL 
...
```sh
git clone https://github.com/GPT-Engineer-App/cmf-edu-hub.git
cd cmf-edu-hub
npm i
